...
2. To translate this approach to different languages - although I love [R](index.qmd) and encourage everyone to use it for statistical analysis, [Python](python.qmd) remains in use by a sizeable number of researchers, and I would also like to introduce Julia as an alternative.
