...
Even if the above code is spaghetti to you (I was originally planning on also converting it to python/matlab, but there are only so many hours in the day), I hope you will take away a few things from this tutorial:
